...
- [ ] Добавлен фильтр ответа от API(safeJson). Баг связан с тем, что если залогиниться и затем разлогиниться, ответ от API приходит с FATAL(данные json приходят, но распарситься не могут на стороне МП), из-за ошибки сессии. В связи с чем, главная страница и каталог пустые.
...
- [x] В режим просмотра Обзоров/Рецептов добавлены дополнитльные поля - text, link и тд
...
- [ ] Форматирование текста по ширине сделать.(Обзоров/Рецептов просмотр)
