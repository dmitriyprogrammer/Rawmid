...
- [ ] 3 если залогиниться, далее я добавлял товар в корзину сувид, потом разлогинитьмя после чего открываете корзину и товара нет, дальше можете опять добавить этот товар в корзину и его опять не будет там. Есть видео
