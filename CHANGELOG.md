...
## Спринт 3: 28.07–03.08.2025

---

### 28.07.2025 
- [x] Перейдя в раздел "статьи", кружки-индикаторы под каруселью статей не меняются в зависимости от прокрутки статей

---

### Backlog / Bugs 28.07–03.08.2025
...
### 25.07.2025 Выполнено - ✅
- [x] Оглавление - оно не так давно появилась на сайте и в приложении в принципе не делали, было бы хорошо сделать.(Обзоров просмотр)
- [x] Добавлены кликабельные ссылки оглавления в Обзорах.
...
- [x] Статьи -> Обзоры (справа внизу) -> Читать (любой) -> отсутствует сам обзор, есть только превью картинка и краткое описание, в responce от api прилетает только title и jpg

---

### 23.07.2025-24.07.2025 Выполнено - ✅
- [x] 3 если залогиниться, далее я добавлял товар в корзину сувид, потом разлогинитьмя после чего открываете корзину и товара нет, дальше можете опять добавить этот товар в корзину и его опять не будет там. Есть видео
...
- [ ] Перейдя в раздел "статьи", в карусель идет подгрузка 10 статей полностью вместо превью версии
- [x] Перейдя в раздел "статьи", кружки-индикаторы под каруселью статей не меняются в зависимости от прокрутки статей
- [x] Зайдя на товар с обзором через главную, например на Дегидратор RAWMID Classic RCD-06, перемотав до обзоров, нажать "Читать", пишет "Статья не найдена"
- [x] Статьи -> Обзоры (справа внизу) -> Читать (любой) -> отсутствует сам обзор, есть только превью картинка и краткое описание, в responce от api прилетает только title и jpg
- [x] Форматирование текста по ширине сделать.(Обзоров/Рецептов просмотр)
- [x] Оглавление - оно не так давно появилась на сайте и в приложении в принципе не делали, было бы хорошо сделать.(Обзоров просмотр)
