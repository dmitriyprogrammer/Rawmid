...
class BannerView extends StatefulWidget {
  const BannerView({super.key, required this.banners, required this.title});

  final List<BannerModel> banners;
  final String title;

  @override
  State<BannerView> createState() => BannerViewState();
}
    ...
    return Column(
        ...
        children: [
          ...
          Padding(
              ...
              child: ModuleTitle(title: widget.title, type: true)
          ),
          h(10),
          Container(
